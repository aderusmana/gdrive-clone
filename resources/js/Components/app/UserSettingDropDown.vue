<template>
    <Menu as="div" class="relative inline-block text-left">
        <div>
            <MenuButton class="inline-flex w-full justify-center rounded-lg  px-8 py-2 text-lg hover:bg-indigo-200 ">
                {{ $page.props.auth.user.name }}


                <ChevronDownIcon class="ml-2 -mr-1 h-5 w-5 text-gray-500 hover:text-gray-800" aria-hidden="true" />
            </MenuButton>
        </div>
            ...
            <MenuItems
                ...
                <div class="px-1 py-1">
                    ...
                    <ResponsiveNavLink :href="route('logout')" method="post" as="button" :class="[
                        ...
                        <ArrowRightOnRectangleIcon :active="active" class="mr-2 h-5 w-5 text-violet-400"
                            aria-hidden="true" />
                        Logout
                    </ResponsiveNavLink>
                    </MenuItem>
