    ...
    <AuthenticatedLayout>
                ...
                <li v-for="ans of ancestors.data" :key="ans.id" class="inline-flex items-center">
                    ...
                    <div v-else class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6 text-gray-700 dark:text-gray-400">
        ...
        <table class="min-w-full">
            ...
            <tbody class="bg-white divide-y divide-gray-200 ">
                <tr v-for="file in files.data" :key="file.id" @dblclick="openFolder(file)" class="hover:bg-indigo-100">
        ...
        <div v-if="!files.data.length" class="py-8 text-center text-lg text-gray-500">
